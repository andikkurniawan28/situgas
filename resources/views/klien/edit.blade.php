        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <strong>Edit {{ ucwords(str_replace('_', ' ', 'klien')) }}</strong>
                </div>
                <div class="card-body">
                    <form action="{{ route('klien.update', $klien->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                value="{{ old('nama', $klien->nama) }}" required autofocus>
                            @error('nama')
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select name="level_klien_id" id="level_klien_id"
                                ...
                                <option value="" disabled>-- Pilih Level Klien --</option>
                                @foreach ($level_kliens as $level)
                                    <option value="{{ $level->id }}"
                                        {{ old('level_klien_id', $klien->level_klien_id) == $level->id ? 'selected' : '' }}>
                                        {{ $level->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="bidang_usaha" id="bidang_usaha"
                                ...
                                value="{{ old('bidang_usaha', $klien->bidang_usaha) }}">
                            @error('bidang_usaha')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="whatsapp" id="whatsapp"
                                ...
                                value="{{ old('whatsapp', $klien->whatsapp) }}">
                            @error('whatsapp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
